...
export class Contract extends ContractBase {
    ...
    globalDirt() {
        return this.eth_call(functions.globalDirt, {})
    }
...
export type GlobalDirtParams = FunctionArguments<typeof functions.globalDirt>
export type GlobalDirtReturn = FunctionReturn<typeof functions.globalDirt>
