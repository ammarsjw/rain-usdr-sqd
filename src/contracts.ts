...
const envAddresses = [
    ...
    process.env.USDR_ADAPTER_ADDRESS,
    process.env.RAIN_ADAPTER_ADDRESS,
    process.env.USDT_ADAPTER_ADDRESS,
    process.env.USDC_ADAPTER_ADDRESS,
    process.env.RAIN_OSM_ADDRESS,
    process.env.PRICE_CONVERTER_ADDRESS,
    process.env.USDT_PSM_ADDRESS,
    process.env.USDC_PSM_ADDRESS,
